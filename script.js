...
function exchangeCard() {
  ...
  let fillet = document.getElementById('fillet')

  background.classList.toggle('backgroundTwo')
  bodyStyle.classList.toggle('bodyStyleTwo')
  fillet.classList.toggle('filletTwo')
}
